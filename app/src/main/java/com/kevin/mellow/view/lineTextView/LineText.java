package com.kevin.mellow.view.lineTextView;
...
public class LineText extends HText {
    ...
    public void setAnimationRepeatCount(int count) {
        this.animationRepeatCount = count;
    }
    ...
    public void init(HTextView hTextView, AttributeSet attrs, int defStyle) {
        ...
        TypedArray typedArray = hTextView.getContext().obtainStyledAttributes(attrs, com.hanks.htextview.line.R.styleable.LineTextView);
...
//        if (!TextUtils.isEmpty(String.valueOf(animationDuration))) {
