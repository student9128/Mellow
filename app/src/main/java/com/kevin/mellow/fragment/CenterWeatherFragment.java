...
public class CenterWeatherFragment extends BaseFragment {


    public static CenterWeatherFragment newInstance(String s) {
        CenterWeatherFragment fragment = new CenterWeatherFragment();
